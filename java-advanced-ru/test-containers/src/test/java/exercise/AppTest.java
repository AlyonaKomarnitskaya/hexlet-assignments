...
public class AppTest {
    ...
    void testGetPerson() throws Exception {
        ...
        assertThat(responsePost.getStatus()).isEqualTo(200);
        assertThat(responsePost.getContentAsString()).contains("John", "Smith");
    }
    ...
    void testGetPeople() throws Exception {
        ...
        assertThat(responsePost.getStatus()).isEqualTo(200);
        assertThat(responsePost.getContentAsString()).contains("John", "Smith");
        assertThat(responsePost.getContentAsString()).contains("Jack", "Doe");
        assertThat(responsePost.getContentAsString()).contains("Jassica", "Simpson");
        assertThat(responsePost.getContentAsString()).contains("Robert", "Lock");
    }
