        ...
        void testUpdatePerson() throws Exception {
            MockHttpServletResponse response = mockMvc
                    .perform(patch("/people/1")
                            .contentType(MediaType.APPLICATION_JSON)
                            .content("{\"firstName\" : \"Jim\", \"lastName\" : \"Moriarty\"}"))
                    .andReturn()
                    .getResponse();
            ...
            assertThat(responseCheck.getContentAsString()).contains("Jim", "Moriarty");
            assertThat(responseCheck.getContentAsString()).doesNotContain("John", "Smith");
        }
